...
const DEFAULTS: Record<number, { morning?: [string, string]; evening?: [string, string] }> = {
  0: { evening: ['14:00', '20:00'] },                                    // א׳ — אין בוקר
  1: { morning: ['07:00', '14:00'], evening: ['14:00', '22:00'] },       // ב׳
  2: { morning: ['07:00', '13:00'], evening: ['13:00', '18:00'] },       // ג׳
  ...
  6: { morning: ['07:00', '14:00'], evening: ['16:00', '20:00'] },       // ש׳
}
