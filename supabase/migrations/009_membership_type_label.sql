-- Add type_label to memberships for storing the original Hebrew membership name
alter table public.memberships add column if not exists type_label text;

-- Update get_family_by_phone to return type_label
